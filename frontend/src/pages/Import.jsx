...
const MODELS = [
  {
    v: 'medium',
    label: 'medium',
    desc: 'Рабочий вариант по умолчанию. Точность ~85%.',
    badge: '~1 мин / рилс',
    tip: 'Где считает — определяется автоматически: на сервере это faster-whisper на CPU воркера GitHub Actions, на Маке с Apple Silicon — mlx-whisper через Neural Engine. Выбирать ничего не нужно.',
  },
  {
    v: 'large-v3',
    label: 'large-v3',
    desc: 'Точность ~95%, вытягивает акценты и шум. Нужен настроенный Kaggle.',
    badge: '~2 мин / рилс (GPU)',
    tip: 'Идёт на бесплатный T4 GPU в Kaggle и требует KAGGLE_KEY и KAGGLE_NOTEBOOK_ID. Если они не заданы, запуск ноутбука молча пропускается, и партию считает обычный воркер на CPU — это в разы дольше и на больших партиях рискует не уложиться в лимит запуска.',
  },
]
